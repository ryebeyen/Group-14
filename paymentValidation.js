...
const paymentTypeBtns = document.querySelectorAll(".payment-method-btn");
...
function updateSubmitState() {
    ...
    const zipValid = zipInput.classList.contains("valid");
    confirmBtn.disabled = !(cardValid && cvvValid && zipValid);
}

paymentTypeBtns.forEach(button => {
...
cvvInput.addEventListener("input", () => {
  validateCard(cvvInput.value);
  updateSubmitState();
});
zipInput.addEventListener("input", () => {
  validateCard(zipInput.value);
  updateSubmitState();
});
